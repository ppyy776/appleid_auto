...
echo "开始下载文件……"
wget https://raw.githubusercontent.com/ppyy776/appleid_auto/main/backend/requirements.txt -O requirements.txt
wget https://raw.githubusercontent.com/ppyy776/appleid_auto/main/backend/unblocker_manager.py -O unblocker_manager.py
SERVICE_FILE="[Unit]
